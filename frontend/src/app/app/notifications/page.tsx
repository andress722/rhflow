...
import { Bell, Check, Trash2, CheckCircle2, AlertTriangle, AlertCircle, Info, Filter, ArrowRight, BookOpen, Calendar, HelpCircle } from 'lucide-react';
...
export default function NotificationsPage() {
  ...
  // Tabs: 'all' (standard alerts) or 'digest' (daily consolidated digest)
  const [activeTab, setActiveTab] = useState<'all' | 'digest'>('all');
